...
void Image(SDL_Renderer* renderer, char* image, int x, int y,
           TextManager* textmanager, Button* button, int index, float mult);
void initialize(SDL_Window **window, SDL_Renderer **renderer, SDL_Texture **texture)
{
	...
	*texture = SDL_CreateTexture(*renderer,SDL_PIXELFORMAT_RGBA8888,SDL_TEXTUREACCESS_TARGET,screen_w,screen_h);
	...
	Image(*renderer,"images2/Facile3.png", 90, 350, &page.textmanager[0], &page.button[0], 0, 1);
	Image(*renderer,"images2/Moyen2.png", 690, 350, &page.textmanager[0], &page.button[0], 1, 1);
	Image(*renderer,"images2/Difficile2.png", 1290, 355, &page.textmanager[0], &page.button[0], 2, 1);
	title(*renderer, "WORD SEARCH SOLVER", screen_w / 2 - 220, 80, &page.textmanager[0], 1);

	
	Image(*renderer, "images2/test.png", 0, 0, &page.textmanager[1], &page.button[1], 0, 1);
	title(*renderer, "Choisir une image", screen_w / 2 - 320, 80, &page.textmanager[1], 2);
	Image(*renderer, "images2/level_1_image_1.png", screen_w * 0.12, 280, &page.textmanager[1], &page.button[1], 1, 1);
	Image(*renderer, "images2/level_1_image_2.png", screen_w * 0.55, 280, &page.textmanager[1], &page.button[1], 2, 1);

	
	Image(*renderer, "images2/Back.png", 0, 0, &page.textmanager[2], &page.button[2], 0, 1);
	title(*renderer, "Choisir une image", screen_w / 2 - 320, 80, &page.textmanager[2], 2);
	Image(*renderer, "images2/level_2_image_1.png", screen_w * 0.1, 280, &page.textmanager[2], &page.button[2], 1, 1);
	Image(*renderer, "images2/level_2_image_2.png", screen_w * 0.6, 280, &page.textmanager[2], &page.button[2], 2, 1);
	

	Image(*renderer, "images2/Back.png", 0, 0, &page.textmanager[3], &page.button[3], 0, 1);
	title(*renderer, "Choisir une image", screen_w / 2 - 320, 80, &page.textmanager[3], 2);
	Image(*renderer, "images2/level_3_image_1.png", screen_w * 0.1, 280, &page.textmanager[3], &page.button[3], 1, 1);
	Image(*renderer, "images2/level_3_image_2.png", screen_w * 0.6, 280, &page.textmanager[3], &page.button[3], 2, 1);
	
	Image(*renderer, "images2/Back.png", screen_w - 300, 00, &page.textmanager[4], &page.button[4], 0, 1);
	Image(*renderer, "images2/Pret2.png", 50, 50, &page.textmanager[4], &page.button[4],1,1);
	Image(*renderer, "images2/reseau.png", 50, 50 + 160, &page.textmanager[4], &page.button[4],2,1);
	Image(*renderer, "images2/grid.png", 50, 50 + 160 * 2, &page.textmanager[4], &page.button[4],3,1);
	Image(*renderer, "images2/lmots.png", 50, 50 + 160 * 3, &page.textmanager[4], &page.button[4],4,1);
	Image(*renderer, "images2/affichage.png", 50, 50 + 160 * 4, &page.textmanager[4], &page.button[4],5,1);
	Image(*renderer, "images2/save.png", 50, 50 + 160 * 5, &page.textmanager[4], &page.button[4],6,1);
	
	Image(*renderer, "images2/Back.png", 0, 0, &page.textmanager[5], &page.button[5], 0, 1);
	title(*renderer, "PRETRAITEMENT DE L'IMAGE", screen_w / 2 - 280, 80, &page.textmanager[5], 1);
	pid_t pid = fork();
           ...
           TextManager* textmanager, Button* button, int index, float mult)
{
    ...
    {
	    SDL_DestroyTexture(textmanager->Tlist[index]);
	    textmanager->Tlist[index] = texture;
            textmanager->rects[index] = rect;
	    return;
    }
				...
				if (b != -1)
				{
					...
					else if (*i == 1 || *i == 2 || *i == 3)
					{
						...
						else if (*i == 1)
						{
							...
							*i = 4;
							SDL_RenderClear(renderer);
							Image(renderer, load, 1000, 200, &page->textmanager[4], &page->button[4], 7, 1);
						}
						else if (*i == 2)
						{
							if (b == 2)
					...
					else if (*i == 4)
					{
						...
						if (b == 1)
						{
							*i = 5;
							...
							Image(renderer, "step1_loaded.bmp", 400, 200, &page->textmanager[5], &page->button[5], 2, 0.6);
							Image(renderer, "step2_no_bruit.bmp", 1100, 200, &page->textmanager[5], &page->button[5], 3, 0.6);
							Image(renderer, "step3_rotated.bmp", 400, 600, &page->textmanager[5], &page->button[5], 4, 0.6);
							Image(renderer, "step4_binary.bmp", 1100, 600, &page->textmanager[5], &page->button[5], 5, 0.6);
						}
					}
					else if (*i == 5)
					{
